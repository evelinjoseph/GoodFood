...
let ListingsService = class ListingsService {
    ...
    initializeItems() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.subscription = yield this.firestore.collection('users').valueChanges().subscribe(data => {
                this.users = data;
            });
            let listing = yield this.firestore.collection('listings').valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).toPromise();
            let retailerListings;
            ...
            yield this.deleteItems();
            this.deleteListings.forEach((element) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.deleteListings.forEach(element => {
                userListings.forEach(user => {
                    if (user.isRetailer == false) {
                        ...
                        let deleteUserListing = userCart.filter(currentListing => {
                            if (currentListing.listingID && element.listingID) {
                                return (currentListing.listingID.toLowerCase().indexOf(element.listingID.toLowerCase()) > -1);
                            }
                        });
...
ListingsService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
ListingsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
