  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function srcAppListingsServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ListingsService = /*#__PURE__*/function () {
        function ListingsService(firestore) {
        ...
        _createClass(ListingsService, [{
          ...
          value: function initializeItems() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
              ...
              var listing, retailerListings;
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      _context4.next = 2;
                      return this.firestore.collection('users').valueChanges().subscribe(function (data) {
                        _this.users = data;
                      });

                    case 2:
                      this.subscription = _context4.sent;
                      _context4.next = 5;
                      return this.firestore.collection('listings').valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).toPromise();

                    case 5:
                      listing = _context4.sent;
                      retailerListings = this.users.filter(function (currentListing) {
                        if (currentListing.isRetailer) {
                          return currentListing.isRetailer;
                        }
                      });
                      this.dateNow = new Date(Date.now());
                      this.deleteListings = listing.filter(function (currentListing) {
                        if (currentListing.deleteDate && _this.dateNow.toUTCString()) {
                          return currentListing.deleteDate.toDate().getTime() <= _this.dateNow.getTime();
                        }
                      });
                      _context4.next = 11;
                    ...
                    case 11:
                      this.deleteListings.forEach(function (element) {
                            ...
                            while (1) {
                              switch (_context3.prev = _context3.next) {
                                case 0:
                                  ...
                                  currentRetailerListing = retailerListings.filter(function (currentListing) {
                                  ...
                                  currentRetailerListing = currentRetailerListing.filter(function (currentListing) {
                      ...
                      listing = listing.filter(function (currentListing) {
                        if (currentListing.deleteDate && _this.dateNow.toUTCString()) {
                          return currentListing.deleteDate.toDate().getTime() > _this.dateNow.getTime();
                        }
                      });
                      return _context4.abrupt("return", listing);
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      userListings = this.users;
                      this.deleteListings.forEach(function (element) {
                        userListings.forEach(function (user) {
                          if (user.isRetailer == false) {
                            var userCart = user.cart;
                            console.log(userCart);
                            var deleteUserListing = userCart.filter(function (currentListing) {
                              if (currentListing.listingID && element.listingID) {
                                return currentListing.listingID.toLowerCase().indexOf(element.listingID.toLowerCase()) > -1;
                              }
                            });
      ...
      ListingsService.ctorParameters = function () {
        return [{
          type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]
        }];
      };

      ListingsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], ListingsService);
      /***/
    }
