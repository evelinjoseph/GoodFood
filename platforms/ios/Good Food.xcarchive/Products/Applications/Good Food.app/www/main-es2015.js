...
const routes = [
    ...
    {
        path: 'initial-page',
        loadChildren: () => Promise.all(/*! import() | initial-page-initial-page-module */[__webpack_require__.e("common"), __webpack_require__.e("initial-page-initial-page-module")]).then(__webpack_require__.bind(null, /*! ./initial-page/initial-page.module */ "./src/app/initial-page/initial-page.module.ts")).then(m => m.InitialPagePageModule)
    },
    {
        path: 'login',
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | retailer-register-retailer-register-module */ "retailer-register-retailer-register-module").then(__webpack_require__.bind(null, /*! ./retailer-register/retailer-register.module */ "./src/app/retailer-register/retailer-register.module.ts")).then(m => m.RetailerRegisterPageModule)
    },
    {
        path: 'tab4',
    ...
    {
        path: 'retailertabs',
        loadChildren: () => __webpack_require__.e(/*! import() | retailertabs-retailertabs-module */ "retailertabs-retailertabs-module").then(__webpack_require__.bind(null, /*! ./retailertabs/retailertabs.module */ "./src/app/retailertabs/retailertabs.module.ts")).then(m => m.RetailertabsPageModule)
    },
    {
        path: 'retailertab1',
    ...
    {
        path: 'user-listing',
        loadChildren: () => __webpack_require__.e(/*! import() | user-listing-user-listing-module */ "user-listing-user-listing-module").then(__webpack_require__.bind(null, /*! ./user-listing/user-listing.module */ "./src/app/user-listing/user-listing.module.ts")).then(m => m.UserListingPageModule)
    },
    {
        path: 'account',
    ...
    {
        path: 'new-listing',
        loadChildren: () => __webpack_require__.e(/*! import() | new-listing-new-listing-module */ "new-listing-new-listing-module").then(__webpack_require__.bind(null, /*! ./new-listing/new-listing.module */ "./src/app/new-listing/new-listing.module.ts")).then(m => m.NewListingPageModule)
    },
    {
        path: 'retailer-listing',
        loadChildren: () => Promise.all(/*! import() | retailer-listing-retailer-listing-module */[__webpack_require__.e("common"), __webpack_require__.e("retailer-listing-retailer-listing-module")]).then(__webpack_require__.bind(null, /*! ./retailer-listing/retailer-listing.module */ "./src/app/retailer-listing/retailer-listing.module.ts")).then(m => m.RetailerListingPageModule)
    },
    {
        path: 'paypal',
    ...
    {
        path: 'password-reset',
        loadChildren: () => __webpack_require__.e(/*! import() | password-reset-password-reset-module */ "password-reset-password-reset-module").then(__webpack_require__.bind(null, /*! ./password-reset/password-reset.module */ "./src/app/password-reset/password-reset.module.ts")).then(m => m.PasswordResetPageModule)
    },
    {
        path: 'update-password',
        loadChildren: () => Promise.all(/*! import() | update-password-update-password-module */[__webpack_require__.e("default~firebase-auth~retailer-update-password-retailer-update-password-module~update-password-updat~c63c26d4"), __webpack_require__.e("default~retailer-update-password-retailer-update-password-module~update-password-update-password-module"), __webpack_require__.e("update-password-update-password-module")]).then(__webpack_require__.bind(null, /*! ./update-password/update-password.module */ "./src/app/update-password/update-password.module.ts")).then(m => m.UpdatePasswordPageModule)
    },
    {
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, nacCtrl, afAuth, afstore) {
...
/* harmony import */ var _ionic_native_email_composer_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ionic-native/email-composer/ngx */ "./node_modules/@ionic-native/email-composer/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_paypal_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ionic-native/paypal/ngx */ "./node_modules/@ionic-native/paypal/__ivy_ngcc__/ngx/index.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"].forRoot({ mode: 'ios' }), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"],
        ...
        providers: [
            ...
            _ionic_native_email_composer_ngx__WEBPACK_IMPORTED_MODULE_15__["EmailComposer"],
            _ionic_native_paypal_ngx__WEBPACK_IMPORTED_MODULE_16__["PayPal"],
...
module.exports = __webpack_require__(/*! /Users/tharunkarakattu/Desktop/Evelin/GoodFood/src/main.ts */"./src/main.ts");
